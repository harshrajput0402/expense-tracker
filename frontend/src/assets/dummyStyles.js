export const dashboardStyles = {
  ...
  gaugeGrid: "grid grid-cols-1 -mx-5 xl:-mx-5 md:grid-cols-3 md:gap-13 lg:gap-3 lg:grid-cols-3 xl:grid-cols-3 gap-6 mb-8",
...
export const sidebarStyles = {
  ...
  // Toggle button
toggleButton: {
  base: "absolute right-0 translate-x-1/2 top-1/2 -translate-y-1/2 z-20 w-8 h-8 bg-white border border-gray-300 rounded-full flex items-center justify-center text-gray-500 shadow-md hover:text-teal-600 hover:border-teal-400 hover:bg-teal-50 transition-all"
},
  ...
  mobileHeader: "pt-25 pb-2 pl-6 pr-3 flex justify-between items-center border-b border-gray-100",
